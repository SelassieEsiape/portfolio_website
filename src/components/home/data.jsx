...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">Aspiring IT Consultant</h3>
        <p className="home__description">I'm a hardworking Information 
            Systems student based in Orem, and I'm very passionate and 
